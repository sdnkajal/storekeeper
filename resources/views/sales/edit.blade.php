        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-3xl font-bold dark:text-white">Product Edit</h3>
                    <form class="max-w-sm mx-auto" action="{{ route('products.update', $product->id) }}" method="post">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="title" name="title"
                                   ...
                                   placeholder="Product Title" value="{{ $product->title ?? old('title') }}">
                            @error('title')
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" id="quantity" name="quantity"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   placeholder="Product Quantity" value="{{ $product->quantity ?? old('quantity') }}" >
                            @error('quantity')
                            <p id="standard_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="price" name="price"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   placeholder="Product Price"  value="{{ $product->price ??  old('price') }}">
                            @error('price')
                            <p id="standard_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
